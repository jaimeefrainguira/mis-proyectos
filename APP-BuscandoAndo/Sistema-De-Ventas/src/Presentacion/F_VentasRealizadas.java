...
public class F_VentasRealizadas extends javax.swing.JInternalFrame {
    public static String vf;
    validaciones validar=new validaciones();
    controladorFactura ctrAnular=new controladorFactura();
    public F_VentasRealizadas() {
        initComponents();
        vf = ("vf");
        ctrAnular.buscar(jTable1, validar.getFecha(),  validar.getFechaHora(), 0,"TODO");
        int xx=0;
//        jXCollapsiblePane1.setCollapsed(true);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(anul_eliminar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE)
    ...
    private void anul_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anul_buscarActionPerformed
        ...
        ctrAnular.buscar(jTable1, fechaDesde,  fechaHasta+' '+validar.getHora(), anul_opciones.getSelectedIndex(),"TODO");
...
//        ctrAnular.anularVenta((ArrayList<AnularVentasDetalle>) ctrAnular.datos.detalle, fila);
        int fila=jTable1.getSelectedRow();
        int codigoCabesera=Integer.parseInt(jTable1.getValueAt(fila, 0).toString());
        String formaPago=String.valueOf(jTable1.getValueAt(fila, 5).toString());
        String estado=String.valueOf(jTable1.getValueAt(fila, 8).toString());
       String numF=validar.convierteNumeroFactura(codigoCabesera);
        try {    
...
//                ctrCompra.getComprasDetalladas(jTable1, fechaDesde,fechaHasta+' '+validar.getHora());
                ...
                parametros.put("codigoCabesera",codigoCabesera);
                parametros.put("formaPago",formaPago);
                 parametros.put("estado",estado);
                 parametros.put("numeroFactura",numF);
