...
public class ProductoAdapter extends RecyclerView.Adapter<ProductoAdapter.HolderNegocio> {

    private List<negocio> atributosList;
    private Context context;

    public ProductoAdapter(List<negocio> atributosList, Context context){
    ...
    public HolderNegocio onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_producto1,parent,false);
