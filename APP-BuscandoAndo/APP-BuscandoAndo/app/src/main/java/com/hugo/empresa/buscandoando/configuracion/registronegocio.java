...
public class registronegocio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registronegocio);
        ...
        //******
        String id=preferences.obtenerPreferenceString(registronegocio.this,preferences.PREFERENCE_USUARIO_LOGIN);
       ...
       // bR = new BroadcastReceiver() {
        ...
        btnRetrocede.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(registronegocio.this, menuconfiguracion.class);
    ...
    public void SolicitarProvincia(String URL){
        StringRequest solicitud=new StringRequest(Request.Method.POST,URL, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(registronegocio.this,"No se logro conectar con el servidor",Toast.LENGTH_SHORT).show();
            }
        });
...
/////////****************************************
    ...
    public void cargaUsuario(JSONObject datos){
        try {
            ...
            if(id_usuario != null){
                String tipo = "";
                if (rbtEmpresa.isChecked()) {
                    tipo = "Empresa";
                }else if (rbtServicio.isChecked()) {
                    tipo = "Servicio";
                }
    ...
    private void GuardarNegocio(String nombre,String descripcion,String direccion,String provincia,String ciudad,String telefono,String celular,String id_usuarioFinal,String tipo,String usuario,String categoria){
     HashMap<String,String> hashMap=new HashMap<>();
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.POST, IP_REGISTRA_NEGOCIO, new JSONObject(hashMap), new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if(resultado.equals("200")) {
                        dialog.dismiss();
                        Toast.makeText(registronegocio.this, "Datos publicados correctamente", Toast.LENGTH_SHORT).show();
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent intent=new Intent(registronegocio.this,com.hugo.empresa.buscandoando.menu.class);
                                startActivity(intent);
                            }
                        },3000);
                        finish();
                        ...
                        dialog.dismiss();
                        Toast.makeText(registronegocio.this, "Problemas al publicar los datos", Toast.LENGTH_SHORT).show();
                    }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(registronegocio.this,"No se conecto con el servidor.",Toast.LENGTH_SHORT).show();
            }
        });
