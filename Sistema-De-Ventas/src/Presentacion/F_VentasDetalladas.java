...
public class F_VentasDetalladas extends javax.swing.JInternalFrame {
    public static String vf;
    validaciones validar=new validaciones();
    controladorFactura ctrFactura=new controladorFactura();
    public F_VentasDetalladas() {
        initComponents();
        vf = ("vf");
        ctrFactura.buscarFacturaAlDetalle(jTable1, validar.getFecha(),  validar.getFechaHora());
        jFormattedTextField1.setValue(ctrFactura.getTotalCantidad());
        jFormattedTextField2.setValue(ctrFactura.getTotalVentas());
        jFormattedTextField3.setValue(ctrFactura.getTotalGananciassss());
        int xx=0;
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(anul_eliminar, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void anul_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anul_buscarActionPerformed
        ...
        ctrFactura.buscarFacturaAlDetalle(jTable1, fechaDesde,  fechaHasta+' '+validar.getHora());
        jFormattedTextField1.setValue(ctrFactura.getTotalCantidad());
        jFormattedTextField2.setValue(ctrFactura.getTotalVentas());
        jFormattedTextField3.setValue(ctrFactura.getTotalGanancias());
...
//        ctrAnular.listaDetalle(anul_tabla2, codigoCabesera);
//        int v=0;
//        ctrAnular.anularVenta((ArrayList<AnularVentasDetalle>) ctrAnular.datos.detalle, fila);
        try {    

                Connection  con =Conexion.Conexion.conectar();

                JasperReport reporte=null;
                String path="src/Reportes/ventasDetalladas.jasper";
...
//                ctrCompra.getComprasDetalladas(jTable1, fechaDesde,fechaHasta+' '+validar.getHora());
                ...
                parametros.put("totaCantidad",jFormattedTextField1.getText());
                parametros.put("totalVentas",jFormattedTextField2.getText());
                parametros.put("totalGanancias",jFormattedTextField3.getText());
