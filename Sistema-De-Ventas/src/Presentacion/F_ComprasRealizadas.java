...
public class F_ComprasRealizadas extends javax.swing.JInternalFrame {
    public static String vf;
    public validaciones validar=new validaciones();
    controladorCompras ctrAnularCompra=new controladorCompras();
    public F_ComprasRealizadas() {
        initComponents();
        vf = ("vf");
        String ff=validar.getFecha();
        String fh=validar.getFechaHora();
        ctrAnularCompra.buscar(jTable1, validar.getFecha(),validar.getFechaHora(), 0,"TODO");
        int xx=0;
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(anul_eliminar, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(6, 6, 6)
...
//        ctrAnularCompra.anularCompra((ArrayList<ComprasDetalleDetallado>) ctrAnularCompra.datos.detalle, fila);
        int fila=jTable1.getSelectedRow();
        int codigoCabesera=Integer.parseInt(jTable1.getValueAt(fila, 0).toString());
        String comprovante=String.valueOf(jTable1.getValueAt(fila, 4).toString());
        String estado=String.valueOf(jTable1.getValueAt(fila, 9).toString());
       String numF=String.valueOf(jTable1.getValueAt(fila, 5).toString());
        try {    

                Connection  con =Conexion.Conexion.conectar();

                JasperReport reporte=null;
                String path="src/Reportes/Compras.jasper";
...
//                ctrCompra.getComprasDetalladas(jTable1, fechaDesde,fechaHasta+' '+validar.getHora());
                ...
                parametros.put("COM_CAB_ID",codigoCabesera);
                parametros.put("TipoComprovante",comprovante);
                 parametros.put("Estado",estado);
                 parametros.put("numeroComprobante",numF);
